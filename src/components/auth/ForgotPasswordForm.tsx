  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Tafadhali angalia barua pepe yako kwa maelekezo zaidi.",
      });
    } catch (error: any) {
      toast({
        variant: "destructive",
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto space-y-6 p-4">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Ingiza barua pepe yako kupata msaada</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        ...
        <Button 
          ...
          disabled={isLoading}
        >
          {isLoading ? "Inatuma..." : "Tuma Maelekezo"}
        </Button>
      </form>
